...
o_ball:		LP LP _B RP double double RP
		{
		    //parent->model.visual.add(new Ball($5.d, $6.d));
		} |
		LP LP _B RP double double double double RP
		{
		    //parent->model.visual.add(new Flag2($5.d, $6.d, $7.d, $8.d, "(b)"));
		};
o_player:	LP LP _P string int RP double double double double double double RP
		{
		    //parent->model.visual.add(new Player1($7.d, $8.d, $9.d, $10.d, $11.d, $12.d, *$4.s, $5.d));
		} |
		LP LP _P string int GOALIE RP double double double double double double RP
		{
		    //parent->model.visual.add(new Player1($7.d, $8.d, $9.d, $10.d, $11.d, $12.d, *$4.s, $5.d, true));
		} |
...
o_flag:		LP LP flag_name RP double double RP
		{
		    //parent->model.visual.add(new Flag2($5.d, $6.d *$3.s);
		}|
		LP LP flag_name RP double double double double RP 
                {
		    //parent->model.visual.add(new Flag2($5.d, $6.d, $7.d, $8.d, *$3.s);
                };
o_line:		LP LP line_name RP double double RP { };
